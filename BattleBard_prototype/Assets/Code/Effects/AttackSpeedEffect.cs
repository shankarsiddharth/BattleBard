...
public class AttackSpeedEffect : Effect
{
	...
	{
		minion_stats.attack_speed = Mathf.Clamp(minion_stats.attack_speed + rawChange, 0.1f, 100f);
		minion_stats.attack_speed = Mathf.Clamp(minion_stats.attack_speed * scalarChange, 0.1f, 100f);
		return minion_stats;
	}
}
