...
public class SFXManager : MonoBehaviour
{
    ...
    private Dictionary<EventManager.Drum, List<AudioSource>> _drumSources;

    // Start is called before the first frame update
    void Start()
    {
        _drumSources = new Dictionary<EventManager.Drum, List<AudioSource>>();
